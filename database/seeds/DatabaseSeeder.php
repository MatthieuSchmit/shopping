...
use App\Models\{Category, User, Address, Country, Product, Colissimo, Range, State, Shop, Page, Order};
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run() {
        ...
        Country::insert([
            ['name' => 'France', 'tax' => 0.2, 'code' => 'FR'],
            ['name' => 'Belgique', 'tax' => 0.2, 'code' => 'BE'],
            ['name' => 'Suisse', 'tax' => 0, 'code' => 'CH'],
            ['name' => 'Canada', 'tax' => 0, 'code' => 'CA'],
        ]);
        Range::insert([
            ['max' => 1],
            ['max' => 2],
        ...
        Category::insert([
            ['name' => 'cat 1', 'category_id' => null],
            ['name' => 'cat 2', 'category_id' => null],
            ['name' => 'cat 3', 'category_id' => null],
            ['name' => 'cat 4', 'category_id' => null],
            ['name' => 'cat 5', 'category_id' => null],
            ['name' => 'cat 3.1', 'category_id' => 3],
            ['name' => 'cat 3.2', 'category_id' => 3],
            ['name' => 'cat 3.1.1', 'category_id' => 6],
        ]);
