    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Adresse de facturation @if($order->addresses->count() === 1) et de livraison @endif</span>
                        @include('account.addresses.partials.address', ['address' => $order->addresses->first()])
                    </div>
                </div>
            </div>
                ...
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            @include('account.addresses.partials.address', ['address' => $order->addresses->get(1)])
                        </div>
                    </div>
                </div>
            @endif
        ...
        <div class="row">
            <a class="waves-effect waves-light btn" href="{{ route('orders.index') }}"> <i class="material-icons left">chevron_left</i>Retour à mes commandes</a>
        </div>
    </div>
@endsection
@section('javascript')
    @include('order.partial.stripejs')
@endsection