...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if($shop->invoice && ($order->invoice_id || $order->state->indice > $abord_indice))
                <div class="card">
    ...
    <div class="card">
        <h5 class="card-header">Client :
            <a href="{{ route('customers.show', $order->user->id) }}"><span class="badge badge-primary">{{ $order->user->first_name . ' ' . $order->user->name }}</span></a>
