        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form method="POST" action="@isset($product) {{ route('products.update', $product->id) }} @else {{ route('products.store') }} @endisset" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <x-select-two
                                    ...
                                    oldID="{{isset($product) ? $product->category_id : 0}}"
                                    oldText="{{isset($product) ? $product->category->name : ''}}"
                            ></x-select-two>
                            <x-inputbs4
                                    name="weight"
                                    type="text"
