        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form method="POST" action="@isset($state) {{ route('states.update', $state->id) }} @else {{ route('states.store') }} @endisset">
                        <div class="card-body">
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-12">
                        <a class="btn btn-primary" href="{{ route('states.index') }}" role="button"><i class="fas fa-arrow-left"></i> Retour à la liste des états</a>
