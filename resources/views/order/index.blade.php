            ...
            <ul class="collection with-header">
                ...
                <div id="wrapper">
                    <li class="collection-item">
                        ...
                        @include('order.partial.addresses', ['name' => 'facturation'])
                        <div class="row">
                            <div class="col s12">
                ...
                @if($addresses->count() === 1)
                                            Vous n'avez qu'une adresse enregistrée, si vous voulez une adresse différente pour la livraison <a href="{{ route('addresses.create') }}">vous pouvez en créer une autre</a>.
                                        @else
                    ...
                    <li id="liLivraison" class="collection-item hide">
                        ...
                        @include('order.partial.addresses', ['name' => 'livraison'])
                    </li>
                    <li class="collection-item">
